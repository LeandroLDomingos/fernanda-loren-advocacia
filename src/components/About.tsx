...
export default function About() {
  return (
    <section id="sobre" className="py-16 md:py-32 px-6 bg-surface relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        >
          ...
          <div className="absolute -bottom-10 -right-10 w-32 md:w-64 h-32 md:h-64 bg-accent/10 -z-10 rounded-full blur-3xl"></div>
          <div className="absolute top-10 -left-10 w-24 md:w-48 h-24 md:h-48 bg-primary/5 -z-10 rounded-full blur-2xl"></div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-6 text-lg font-serif text-primary/80 leading-relaxed">
            <p>
              Com atuação dedicada à defesa dos direitos de quem contribuiu para o desenvolvimento do nosso país.
            </p>
            <p>
          ...
          <div className="pt-8 grid grid-cols-2 gap-8">
            ...
            <div>
              <span className="block text-3xl font-serif text-primary">1k+</span>
