...
const testimonials = [
  {
    ...
    text: "A Dra. Fernanda Loren foi fundamental para a concessão da minha aposentadoria. O atendimento é humano e muito transparente. Recomendo a todos que precisam de ajuda com o INSS.",
...
export default function Testimonials() {
  return (
    <section id="depoimentos" className="py-32 px-6 bg-bg-light relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-24 text-center space-y-4">
          <span className="text-accent font-sans font-bold text-[10px] uppercase tracking-[0.5em]">DEPOIMENTOS</span>
          <h2 className="text-5xl md:text-7xl font-serif text-primary">Histórias que nos <span className="italic text-accent">inspiram</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {testimonials.map((t, i) => (
            ...
            >
              <Quote className="absolute top-8 right-8 size-12 text-accent/10 group-hover:text-accent/20 transition-colors" />
