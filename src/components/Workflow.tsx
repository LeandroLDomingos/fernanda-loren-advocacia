...
export default function Workflow() {
  return (
    <section className="py-16 md:py-32 px-6 bg-bg-light">
        ...
        <div className="space-y-4 md:space-y-6">
          {steps.map((step) => (
            <motion.div
              ...
              className="bg-white border border-accent/10 p-6 md:p-16 flex flex-col md:flex-row md:items-center gap-6 md:gap-12 group hover:bg-surface transition-all duration-500 rounded-sm shadow-sm"
            >
              <div className="text-5xl md:text-8xl font-serif font-light text-accent/10 group-hover:text-accent/30 transition-colors duration-500 italic">
                {step.id}
              </div>
              <div className="flex-1">
                <div className="text-[9px] font-sans font-bold text-accent mb-3 md:mb-4 uppercase tracking-[0.3em]">
                  {step.phase}
                </div>
